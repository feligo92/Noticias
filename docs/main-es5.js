(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ArticuloComponent = /** @class */ (function () {
                function ArticuloComponent(_data, _path) {
                ...
                ArticuloComponent.prototype.ngOnInit = function () {
                    ...
                    this.subscription = this._data.data.subscribe(function (newValue) {
                        ...
                        _this.arrArticulos = _this.data["articles"];
                        _this.singleArticulo = _this.arrArticulos[_this.id];
                        console.log(_this.singleArticulo);
                    });
                };
                return ArticuloComponent;
            }());
            ArticuloComponent.ctorParameters = function () { return [
            ...
            var HomeComponent = /** @class */ (function () {
                function HomeComponent(_data) {
                    ...
                    this.subscription = this._data.data.subscribe(function (newValue) {
                        _this.data = newValue;
                        _this.arrArticulos = _this.data["articles"];
                        console.log(_this.arrArticulos);
                    });
                    this.busqueda = "";
                ...
                //HOY
                HomeComponent.prototype.getHoy = function () {
                    var _this = this;
                    this._data.llamadaGet("https://cors-anywhere.herokuapp.com/https://newsapi.org/v2/everything?language=es&from=2019-11-15&q=noticia&apiKey=afea889eae7d463b855fd2b78dc6c4c7&pageSize=12");
                    this.subscription = this._data.data.subscribe(function (newValue) {
                        _this.data = newValue;
                ...
                //MIS CATEGORIAS
                HomeComponent.prototype.getResistencia = function () {
                    var _this = this;
                ...
                HomeComponent.prototype.getBarca = function () {
                    var _this = this;
                    this.busqueda = "barça";
                    this._data.llamadaGet("https://cors-anywhere.herokuapp.com/https://newsapi.org/v2/everything?language=es&q=" + this.busqueda + "&apiKey=afea889eae7d463b855fd2b78dc6c4c7&pageSize=12");
                    this.subscription = this._data.data.subscribe(function (newValue) {
                ...
                HomeComponent.prototype.getLol = function () {
                    var _this = this;
                ...
                //Buscar
                HomeComponent.prototype.getBusqueda = function () {
                    var _this = this;
                    ...
                    this.subscription = this._data.data.subscribe(function (newValue) {
                        _this.data = newValue;
                        _this.arrArticulos = _this.data["articles"];
                        console.log(_this.arrArticulos, _this.busqueda);
                    });
                };
